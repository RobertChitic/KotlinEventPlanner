...
class MainWindow(
    ...
    private fun generateSchedule() {
        ...
        try {
            // Use reflection to call EventScheduler.scheduleEvents and scheduleToMap
            val eventSchedulerClass = Class.forName("com.eventplanning.scheduling.EventScheduler")
            val companionField = eventSchedulerClass.getField("MODULE$")
            val eventSchedulerInstance = companionField.get(null)
            ...
            val result = scheduleEventsMethod.invoke(
                eventSchedulerInstance,
                events,
                venues
            )
            ...
            val resultMap = scheduleToMapMethod.invoke(
                eventSchedulerInstance,
                result
